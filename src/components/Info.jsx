                ...
                <div className="myDetails">
                    ...
                    <section aria-labelledby="achievements-heading">
                        ...
                        <ul className='cert-styling'>
                            <li><a href='/portfolio-site/public/certificates/Ramiro Renteria-Student-ID-22324-Full Stack Web-App Development Course.pdf' target="_blank" rel="noopener noreferrer" aria-label="Full Stack Web-App Development Course Certificate">Full Stack Cert</a></li>
                            <li><a href='/portfolio-site/public/certificates/Ramiro Renteria-Student-ID-22324-Front End Web-App Development Course.pdf' target="_blank" rel="noopener noreferrer" aria-label="Front End Web-App Development Course Certificate">Front End Cert</a></li>
                            <li><a href='/portfolio-site/public/certificates/Ramiro Renteria-Student-ID-22324-Intro to Back-End Web-Development Module.pdf' target="_blank" rel="noopener noreferrer" aria-label="Intro to Back-End Web-Development Module Certificate">Back End Cert</a></li>
                            <li><a href='./portfolio-site/public/certificates/ResumeMostCurrent1.pdf' target="_blank" rel="noopener noreferrer" aria-label="Ramiro Renteria Resume">Resume</a></li>
                        </ul>
                    </section>
                </div>
            </div>
